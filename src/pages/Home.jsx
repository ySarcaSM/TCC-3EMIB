        ...
        <IonToolbar>
          <IonTitle>
            <span style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <IonIcon icon={flaskOutline} style={{ color: '#e8a838', fontSize: '1.2rem' }} />
              MathForge
            </span>
          </IonTitle>
        </IonToolbar>
      ...
      <IonContent fullscreen>
        <div style={{ padding: '2rem 1.5rem 1rem' }}>
          ...
          <p className="hero-subtitle">
            Editor LaTeX com preview ao vivo, detecção de variáveis e reutilização de expressões.
          </p>
          <IonButton
            color="primary"
        ...
        {formulas.length > 0 && (
          ...
          >
            ...
            >
              {formulas.length} fórmula{formulas.length !== 1 ? 's' : ''} criada{formulas.length !== 1 ? 's' : ''}
            </span>
            {favoritasCount > 0 && (
              <IonChip style={{ margin: 0 }}>
                <IonIcon icon={star} style={{ color: '#e8a838', marginRight: '4px', fontSize: '0.8rem' }} />
        ...
        {filtered.length > 0 ? (
          ...
          <div style={{ textAlign: 'center', padding: '3rem 1rem', color: '#6a6270' }}>
            <p>Nenhuma fórmula encontrada para "{search}"</p>
          </div>
        ) : (
          <div style={{ textAlign: 'center', padding: '3rem 1.5rem', color: '#6a6270' }}>
            <IonIcon
              icon={flaskOutline}
            ...
            <p style={{ marginBottom: '1rem' }}>Crie sua primeira fórmula no editor</p>
            <IonButton
              fill="outline"
              color="primary"
              size="small"
        ...
        <IonAlert
          ...
          buttons={[
            ...
            { text: 'Excluir', role: 'destructive', handler: handleConfirmDelete },
          ]}
        />
      </IonContent>
    </IonPage>
